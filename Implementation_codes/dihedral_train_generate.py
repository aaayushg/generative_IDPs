...
infile = pd.read_csv('/home/aayush/Documents/GenIDP/input_data/ab40/run1/mdana_backbone/CCAN/aayush_ip.dat', delim_whitespace=True)
...
#decoded_test_prots = ((decoded_test_prots * 360) - 180)
...
#decoded_cov_prots = ((decoded_cov_prots * 360) - 180)
